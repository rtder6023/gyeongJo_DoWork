...
const List = React.memo(
  ({
    ...
    todoData,
    setTodoData,
    provided, // provided를 받음
    snapshot, // snapshot을 받음
    handleClick,
  }) => {
    ...
    if (isEditing) {
      ...
      return (
        <div
          key={id}
          {...provided.draggableProps} // draggableProps를 적용
          ref={provided.innerRef} // innerRef를 적용
          {...provided.dragHandleProps} // dragHandleProps를 적용
          className={`${
